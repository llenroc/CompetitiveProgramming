namespace HackerRank.WorldCodesprint.PrimeDigitSum
{
    using System;
    ...
    class Solution
    {
        static void Driver(String[] args)
        {
            ...
            long xor = 0;
            foreach (var n in Enumerable.Range(1, 400000))
            {
        ...
        static int maxCalced;

        static long[] tables = new long[10000];
        static int[] tablests = new int[10000];
        static long[] scratch = new long[10000];
        static int[] scratchts = new int[10000];
        static int ts = 1;

        static int[] counts = new int[500000];
        static int[] counts0 = new int[500000];
