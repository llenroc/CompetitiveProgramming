...
class Solution
{
	...
	public class FFT
	{
		...
		public unsafe List<long> Multiply(List<long> a, List<long> b)
		{
			...
			// Try out both, sometimes the second one is faster even though the first is constant time.
#if false
			...
			Array.Reverse(nar, 1, n - 1);
			Array.Reverse(nai, 1, n - 1);
			Array.Reverse(nbr, 1, n - 1);
			Array.Reverse(nbi, 1, n - 1);
