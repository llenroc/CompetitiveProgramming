...
class Solution
{
	...
	{
		var s = Ns();
		WriteLine(SumOfSquareDigits(s));
	}


	public static long SumOfSquareDigits(string number)
	{
		int n = number.Length;
		int max = 81 * n;
	...
	public static long CountSumOfSquareDigits(string s)
	{
		int n = s.Length;
		int max = 81 * n;
